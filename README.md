...
![My Skills](https://skillicons.dev/icons?perline=12&i=html,css,bootstrap,tailwind,js,ts,vue,react,vite,astro,next,nodejs,express,nest,php,laravel,redux,jest,prisma,kotlin,flutter,mysql,postgres,firebase,supabase,docker)
