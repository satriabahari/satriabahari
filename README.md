...
![My Skills](https://skillicons.dev/icons?perline=10&i=html,css,bootstrap,tailwind,js,ts,vue,react,vite,astro,next,nodejs,express,nest,php,laravel,redux,jest,prisma,mysql,postgres,firebase,supabase,docker)
